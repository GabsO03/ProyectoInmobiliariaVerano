...
public class Proyecto {
    ...
    //constructores
    public Proyecto(int codigo, String nombre, String descripcion, String tipo, String fechaInicio, String fechaFin, double cantidadNecesaria, double cantidadFinanciada, boolean habilitado) {
        this.codigo = codigo;
        this.nombre = nombre;
    ...
    public Proyecto(int codigo, String nombre, String descripcion, String tipo, String fechaInicio, String fechaFin, double cantidadNecesaria) {
        this.codigo = codigo;
        this.nombre = nombre;
        this.descripcion = descripcion;
        this.tipo = tipo;
    ...
    public double getPorcentaje () {
        return (cantidadFinanciada/cantidadNecesaria)*100;
    }
